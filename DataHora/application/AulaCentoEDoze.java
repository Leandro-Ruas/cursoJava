...
public class AulaCentoEDoze {

	public static void main(String[] args) {
		
		// ZoneId.getAvailableZoneIds(); -> Classe que permite o retorno de todos os time zones existentes.
		...
		LocalDateTime d05 = LocalDateTime.parse("2022-06-18T01:30");
		Instant d06 = Instant.parse("2022-06-18T01:30:26Z");
